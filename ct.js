...
const ct = {
     ...
     */
    version: '1.7.0',
    meta: [{"name":"PingPong","author":"Dak12","site":"","version":"1.0.0"}][0],
    main: {
        fpstick: 0,
        pi: 0
    },
...
ct.inputs.addAction('MoveX', [{"code":"keyboard.KeyA","multiplier":-1},{"code":"keyboard.KeyD"}]);
ct.inputs.addAction('MoveX2', [{"code":"keyboard.ArrowLeft","multiplier":-1},{"code":"keyboard.ArrowRight"}]);
...
ct.rooms.templates['MainRoom'] = {
    ...
    objects: JSON.parse('[{"x":4,"y":4,"exts":{},"type":"Bg"},{"x":320,"y":64,"exts":{},"type":"BALL01"},{"x":576,"y":192,"exts":{},"type":"BALL01"},{"x":320,"y":576,"exts":{},"type":"Paddle01"},{"x":320,"y":549,"exts":{},"type":"Paddle002"}]'),
    bgs: JSON.parse('[]'),
...
(function resAddon(ct) {
    ...
    ct.res = {
        ...
        soundsError: 0,
        sounds: {},
        registry: [{"Bg":{"atlas":"./img/t0.png","frames":0,"shape":{"type":"rect","top":0,"bottom":590,"left":0,"right":790},"anchor":{"x":0,"y":0}},"PBALL32":{"frames":1,"shape":{"type":"rect","top":0,"bottom":32,"left":0,"right":32},"anchor":{"x":0,"y":0}},"Paddle01":{"frames":1,"shape":{"type":"rect","top":0,"bottom":16,"left":0,"right":128},"anchor":{"x":0,"y":0}},"Paddle02":{"frames":1,"shape":{"type":"rect","top":0,"bottom":16,"left":0,"right":128},"anchor":{"x":0,"y":0}}}][0],
...
if(this.y >= 580){
    this.y = 580;
    this.kill = true;  
    ct.types.copy('BALL01', ct.random(ct.camera.width), ct.random(ct.camera.height));
    ct.room.score -= 1;
}

var collided = ct.place.meet(this, this.x, this.y, 'Paddle01')
if(collided){
    this.yDirection = -5;
    ct.room.score += 1;
}

var collided = ct.place.meet(this, this.x, this.y, 'Paddle002')
if(collided){
    this.yDirection = -5;
    ct.room.score += 1;
}
...
this.move();
    ...
    onCreate: function () {
        this.speed = 2;
this.x = ct.random.range(5, 600); 
this.y = ct.random.range(5, 100);
this.xDirection = 1;
this.yDirection = 1;
this.direction = 0;
...
ct.types.list['BALL01'] = [];
ct.types.templates["Paddle01"] = {
    depth: 0,
    texture: "Paddle01",
    onStep: function () {
        this.x += 20 * ct.delta * ct.actions.MoveX.value;
...
ct.types.list['Paddle01'] = [];
ct.types.templates["Paddle002"] = {
    depth: 0,
    texture: "Paddle02",
    onStep: function () {
        this.x += 20 * ct.delta * ct.actions.MoveX2.value;
